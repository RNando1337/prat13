 ...
 */
 ...
 'smtp_user' => 'projekomahoutfit@gmail.com', // Ganti dengan email gmail kamu
 'smtp_pass' => 'l33thax0r', // Password gmail kamu
 'smtp_port' => 465,
 'crlf' => "\r\n",
 'newline' => "\r\n"
 ];
 ...
 $this->email->from('no-reply@dinustek.com', 'dinustek.com | masaboe');
 // Email penerima
 $this->email->to('nandorejal@gmail.com'); // Ganti dengan email tujuan kamu
